sap.ui.define([
	...
	return Opa5.extend("myfiori.myFiori.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["myfiori/myFiori/localService/mockserver"], function (mockserver) {
