...
sap.ui.define([
	...
	return BaseController.extend("myfiori.myFiori.controller.Worklist", {
		...
		onShowDetailPopover: function (oEvent) {
			...
			// open dialog
			var oOpen = oEvent.getParameter("domRef");
			oPopover.openBy(oOpen);
		},
		_getPopover: function () {
			...
			if (!this._oPopover) {
				...
				"myfiori.myFiori.view.ResponsivePopover", this);
